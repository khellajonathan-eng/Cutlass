...
v1 = "None." #x.x.x.V
v2 = "Added onanyhook method which triggers on any event inside EventHook, as well as a System.checkv() method to check the version of the script run." #x.x.V.x
