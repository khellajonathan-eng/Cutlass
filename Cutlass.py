...
v1 = "Fixed a few bugs as well as made it so into accepts (room, item) if there is a merchant and (map, room, item) if you are not in a map or room." #x.x.x.V
                            ...
                            if r == ans:
                                ...
                                if Map.Room.roomsnames[r].loot[:]:
                                    if Map.Room.roomsnames[r].merchant:
                                        if isinstance(into, tuple) and len(into) > 2:
                                            ans = into[2]
                                        else:
                ...
                for r in roomss:
                    if r == ans:
                        ...
                        if Map.Room.roomsnames[r].loot[:]:
                            if Map.Room.roomsnames[r].loot[:]:
                                    if Map.Room.roomsnames[r].merchant:
                                        if isinstance(into, tuple) and len(into) > 1:
                                            ans = into[1]
                                        else:
                                            print("Would you like to see my wares?")
                                            print("\n---".join(Map.Room.roomsnames[r].loot))
